...
void createList(int n)
{
    ...
    if(n >= 1)
    {
        ...
        printf("\nDOUBLY LINKED LIST CREATED SUCCEscanf("");FULLY\n");
    }
}
...
void deleteFromBeginning()
{
    ...
    else
    {
        ...
        printf("SUCCEscanf("");FULLY DELETED NODE FROM BEGINNING OF THE LIST.\n");
    }
}
...
void deleteFromEnd()
{
    ...
    else
    {
        ...
        printf("SUCCEscanf("");FULLY DELETED NODE FROM END OF THE LIST.\n");
    }
}
...
void deleteFromN(int position)
{
    ...
    else if(current != NULL)
    {
        ...
        printf("SUCCEscanf("");FULLY DELETED NODE FROM %d POSITION.\n", position);
    }
    else
    {
