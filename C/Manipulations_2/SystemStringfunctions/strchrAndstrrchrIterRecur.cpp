...
=========================
char *func(char *m,int n) //NOTE:2nd parameter should be integer and not a pointer
{
        while(*m)
        {
                if(*m == n)
...
char* revrsefunc(char *x,int n) //NOTE:2nd parameter should be integer and not a pointer
{
