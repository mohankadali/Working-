...
if str(sys.argv[5]) == "nxp":
	cmd = 'python3 '+cwd+'/nxp/external_update.py'+' '+ str(sys.argv[1]) +' '+str(sys.argv[2])+' '+str(sys.argv[3])+' '+str(sys.argv[4])+' '+str(sys.argv[5])

	if os.system(cmd) == 0:
		print("external_update.py exicuted.........\n")
	else:
...
# executing python scripts for qcom
	...
	cmd = 'python3 '+cwd+'/qcom/external_update.py'+' '+ str(sys.argv[1]) +' '+str(sys.argv[2])+' '+str(sys.argv[3])+' '+str(sys.argv[4])+' '+str(sys.argv[5])
