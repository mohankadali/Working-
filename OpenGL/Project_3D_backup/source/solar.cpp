...
//******* continues rotation *******/
    ...
    mercuryAngle = mercuryAngle + mercury/5;
    vinusAngle = vinusAngle + vinus/7;
    earthAngle = earthAngle + earth/10;
    marsAngle = marsAngle + mars/15;
    juAngle = juAngle + ju/20;
    saAngle = saAngle + sa/30;
    urAngle = urAngle + ur/40;
    neAngle = neAngle + ne/50;
