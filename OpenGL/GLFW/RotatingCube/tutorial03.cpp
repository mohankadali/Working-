...
*/
        ...
        do{
                ...
                glm::mat4 Model;
                Model = glm::translate(glm::mat4(2.0f),glm::vec3(5,0,0));
                Model = glm::scale((glm::mat4(2.0f)),glm::vec3(1.9f,1.9f,1.9f));       
                Model = glm::rotate(glm::mat4(2.0f),(GLfloat)glfwGetTime()*2.0f,glm::vec3(1.0f,0.0f,1.0f));
